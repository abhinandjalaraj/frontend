...
<div className='capitalize ' >
      <div className='flex justify-between p-5  bg-gray-800  text-white max-sm:flex-col gap-5 max-sm:justify-center max-sm:items-center  max-sm:p-0   max-sm:pt-3'>
      ...
      <div className="  bg-gray-950 w-full flex items-center justify-center text-white max-sm:text-center  max-sm:pt-3">
